...
export const WORKING_CALENDAR_WEEKDAY_LABELS_TR = [
  'Pazartesi',
  'Salı',
  'Çarşamba',
  'Perşembe',
...
/** Sistem / İzin takvimleri için ortak hücre buton sınıfları (boyut + okunabilirlik) */
export const WORKING_CALENDAR_CELL_BUTTON_CLASS =
  'rounded-lg p-2 min-h-[80px] min-w-0 max-w-full text-left transition-colors overflow-hidden flex flex-col';
