          ...
          <div className="relative z-10 flex min-h-full items-center justify-center p-4">
            <div
              className="
                ...
                w-[calc(100vw-72rem)] max-w-4xl
                max-h-[90vh] rounded-2xl border border-white/10
                shadow-[0_25px_80px_rgba(0,0,0,.6)] w-full max-w-[min(1400px,calc(100vw-32px))] flex flex-col overflow-hidden
              "
            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <h2 className="text-xl md:text-2xl font-semibold text-white">Tümünü düzenle</h2>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button className="rounded-md px-2 py-1 text-xs text-neutral-300 hover:bg-white/10">📝</button>
                  <button className="rounded-md px-2 py-1 text-xs text-rose-300 hover:bg-white/10">🗑️</button>
                </div>
              </div>
              ...
              <div className="flex-1 flex min-w-0 overflow-hidden overflow-x-hidden divide-x divide-white/10">
                ...
                <div className="flex-1 min-w-0 overflow-y-auto px-6 sm:px-10">
                  <div className="max-w-4xl mx-auto py-6 space-y-6">
                    ...
                    <div className="flex gap-4 items-center min-w-0">
                      ...
                      <a
                        ...
                        className="flex-1 min-w-0 inline-flex items-center min-h-[56px] w-full rounded-lg border border-white/10 bg-[#0d1b2a]/60 px-4 !text-[20px] text-sky-400 hover:text-sky-300 hover:border-sky-500/50 transition-colors"
                      >
                        Bağlantıyı aç
                      </a>
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={4}
                        className="w-full min-h-[96px] rounded-lg border border-white/10 bg-[#0d1b2a]/60 px-4 py-3 text-[15px] text-slate-100 focus:outline-none focus:ring-2 focus:ring-sky-500/40 focus:border-sky-500/60 resize-y"
                      />
                    </div>
                ...
                <div className="w-[490px] shrink-0 bg-[#0f172a] flex flex-col overflow-hidden">
                  <div className="p-4 border-b border-white/10 flex-none">
                    <div className="flex items-center justify-between">
                      ...
                      <button className="rounded px-2 py-1 text-neutral-300 hover:bg-white/10">⚙️</button>
                    </div>
                  </div>
                        ...
                        <div key={h.id} className="bg-white/5 border border-white/10 p-3 rounded">
                          ...
                          <div className="flex items-start gap-2">
                            <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-white text-xs">
                              {h.user?.name?.charAt(0) || 'U'}
                            </div>
                            <div className="text-sm">
                              <span className="font-medium text-white">{h.user?.name || 'Kullanıcı'}</span>{' '}
                              {(h.field === 'status' && 'durumu') || (h.field === 'priority' && 'önceliği') || h.field}{' '}
                              değiştirdi: <span className="text-neutral-300">{getStatusText(h.old_value) || 'boş'}</span> →{' '}
                              <span className="text-neutral-300">{getStatusText(h.new_value) || 'boş'}</span>
                            </div>
                          </div>
                        </div>
                      ))
                  ...
                  <div className="p-4 border-t border-white/10 flex-none">
                    ...
                    <div className="mt-2 flex items-center justify-between">
                      <div className="flex gap-2 text-neutral-300">
                        <button className="rounded px-2 py-1 hover:bg-white/10">📎</button>
                        <button className="rounded px-2 py-1 hover:bg-white/10">😊</button>
                      </div>
                      <button
