...
function App() {
    ...
    async function loadNotifications() {
        try {
            ...
            console.log('Loaded notifications:', notificationsList); // Debug için
            // Array kontrolü ekle
                                            ...
                                            <button
                                                onClick={async () => {
                                                    try {
                                                        ...
                                                        addNotification('Tüm bildirimler okundu', 'success');
                                                    } catch (err) {
                                                        addNotification('Bildirimler işaretlenemedi', 'error');
                                                    }
                                                }}
                                                                    ...
                                                                    <button
                                                                        onClick={async () => {
                                                                            try {
                                                                                ...
                                                                                addNotification('Bildirim işaretlenemedi', 'error');
                                                                            }
                                                                        }}
                                                                        className="text-blue-600 hover:text-blue-800 text-xs"
                                                                    >
            ...
            <div className="bg-white">
                <div className="px-6">
                    <h2 className="text-lg font-semibold text-gray-900 py-4 border-b border-gray-200">
                        Mühendislik_Revizyon_Talepleri ⭐ ✓
                    </h2>
                </div>
